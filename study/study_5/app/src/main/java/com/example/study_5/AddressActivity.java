...
public class AddressActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        name.setText("收货人："+bundle.getString("name"));//获取输入的姓名并显示到TextView组件中
        TextView phone = (TextView) findViewById(R.id.phone);//获取显示手机号码的TextView组件
        phone.setText("收货人电话："+bundle.getString("phone"));//获取输入的电话号码并显示到TextView组件中
        TextView site = (TextView) findViewById(R.id.site);//获取显示地址的TextView组件
        //获取输入的地址并显示到TextView组件中
        site.setText("收货地址："+bundle.getString("site1")
