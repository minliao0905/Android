...
import com.example.myemo.ui.Fragment.changeimage.ImgURi.headimgActivity;
import com.example.myemo.ui.Fragment.changeimage.MakeImg.ImageSplitter;
import com.example.myemo.ui.Fragment.changeimage.MakeImg.ImgGameView;
...
public class ImgActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.chi_mainimg);
        init();
    }
    /**
     *
...
//        Log.v("ImgActivity","加载");
        ...
        if(inflater!=null){
            inflater.inflate(R.menu.chimain, menu);
        }else{
            Log.v("ImgActivity","菜单加载失败");
        }
